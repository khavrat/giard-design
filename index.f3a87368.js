...
})({"epPdV":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "95f437e7f3a87368";
"use strict";
...
},{}],"9ZRqK":[function(require,module,exports) {
(()=>{
    ...
    modalData.forEach((data)=>{
        if (data.openBtn instanceof NodeList) data.openBtn.forEach((btn)=>{
            btn.addEventListener("click", ()=>toggleModal(data));
        });
        else data.openBtn.addEventListener("click", ()=>toggleModal(data));
        data.closeBtn.addEventListener("click", ()=>toggleModal(data));
        data.backdropBlur.addEventListener("click", (e)=>handleBackdropClick(e, data));
        ...
        function handleBackdropClick(e, data) {
            e.preventDefault();
            if (e.target === data.backdropBlur) toggleModal(data);
        }
        //for modal search
...
},{}]},["epPdV","9ZRqK"], "9ZRqK", "parcelRequire3110")

//# sourceMappingURL=index.f3a87368.js.map
