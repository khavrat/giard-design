...
})({"ddFtd":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4795f06ff8233100";
"use strict";
...
async function fetchImages() {
    try {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}?q=garden&key=${API_KEY}&image_type=photo&per_page=${perPage}&page=${currentPage}`);
...
async function getContent() {
    ...
    const renderData = contentData.map((image)=>`<div class="masonryItem bg-modalBg sm:w-[100%] md:w-[50%] lg:w-[33.333%] mb-[10px] drop-shadow-md hover:shadow-lg  transform transition-transform ease-in hover:scale-105 hover:translate-y-[-2px] cursor-pointer"><img class="w-[100%] h-[100%] px-2 pt-2 pb-6 block grayscale hover:grayscale-0" src="${image.webformatURL}" alt="project"></div>`).join("");
    galleryContainer.innerHTML = renderData;
    setTimeout(()=>{
        new (0, _masonryLayoutDefault.default)(galleryContainer, {
...
async function toggleValueContent(e) {
    ...
    if (galleryContainer.classList.contains("toggle-value-content")) {
        ...
        smokeBg.classList.add("bg-gradient-to-t", "from-secondaryBg", "dark:from-modalBg");
        ...
        smokeBg.classList.remove("bg-gradient-to-t", "from-secondaryBg", "dark:from-modalBg");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cYDx4":[function(require,module,exports) {
/*!
 * Masonry v4.2.2
