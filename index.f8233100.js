...
async function fetchImages() {
    try {
        const response = await axios.get(`${BASE_URL}?q=garden&key=${API_KEY}&image_type=photo&per_page=${perPage}&page=${currentPage}`);
...
},{"../../images/overall/attach.png":"8l92I","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8l92I":[function(require,module,exports) {
