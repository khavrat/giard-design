...
function handleSearch() {
    ...
    tags.forEach((tag)=>{
        ...
        if (title.includes(searchTag) && searchTag !== "") {
            ...
            resultItem.classList.add("block", "p-4", "font-medium", "text-sm", "menu-item", "rounded-lg", "hover:bg-hoverBg", "hover:text-secondBrand");
...
},{}]},["6hF2V","4TESp"], "4TESp", "parcelRequire3110")
